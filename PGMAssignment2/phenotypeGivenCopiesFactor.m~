...
for i=1:numAlleles
	for j=1:numAlleles
		genotypeVar = allelesToGenotypes(i,j);
		assignments = [assignments;[1,i,j];[2,i,j]];
		val = [val,alphaList(genotypeVar),1-alphaList(genotypeVar)];
	end
end


indexes = AssignmentToIndex(assignments, phenotypeFactor.card);

disp(indexes);


phenotypeFactor.val(indexes') = val;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
