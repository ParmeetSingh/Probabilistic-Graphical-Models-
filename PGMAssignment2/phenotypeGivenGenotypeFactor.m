...
assignments = [1,1;1,2;1,3;2,1;2,2;2,3];

indices = AssignmentToIndex(assignments, phenotypeFactor.card);

indices_values = [alphaList,1-alphaList];

phenotypeFactor.val = zeros(1, prod(phenotypeFactor.card));

phenotypeFactor.val(indices) = indices_values;
